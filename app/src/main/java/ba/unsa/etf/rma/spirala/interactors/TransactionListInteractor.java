...
public class TransactionListInteractor extends AsyncTask<String, Integer, Void> implements ITransactionListInteractor {
    ...
    private OnTransactionGetDone caller;//= (OnTransactionGetDone) this;
    ...
    protected Void doInBackground(String... strings) {
        String query = "";
        query = strings[0];
        String url2 = glavniURL + api_id + "/transactions" + query;
        try {
    ...
    public ArrayList<Transaction> getTransactionCursor(Context context) {
        ...
        String where = TransactionDBOpenHelper.TRANSACTION_DATE + " LIKE '" + dateFormat.format(PocetnaAktivnost.defaultDate) + "%'";
